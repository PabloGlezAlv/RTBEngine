...
namespace RTBEngine {
    namespace Online {
        ...
        public:
            ...
            static bool RegisterTransformObjectKey(const std::string& objectKey);
            static void UnregisterTransformObjectKey(const std::string& objectKey);
            static bool IsTransformObjectKeyRegistered(const std::string& objectKey);
        };
